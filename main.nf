...
params.dotplot_output = 'dotplot.png'
params.gene_overlap_output = 'gene_overlap.png'
...
process RUN_SPAPROS {
    ...
    path params.gene_overlap_output
    ...
    cli += ['--gene-overlap-output', params.gene_overlap_output]
